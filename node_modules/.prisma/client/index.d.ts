...
export namespace Prisma {
  ...
  */
  ...
  type GetRecommendationGroupByPayload<T extends RecommendationGroupByArgs> = PrismaPromise<
    Array<
  ...
  export type RecommendationGetPayload<
    ...
    P extends keyof Recommendation ? Recommendation[P] : never
  } 
    : Recommendation
  : Recommendation
  ...
  export interface RecommendationDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    ...
    **/
    ...
    /**
     * Find one Recommendation that matches the filter or throw
    ...
    **/
    ...
    >(args: SubsetIntersection<T, RecommendationGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetRecommendationGroupByPayload<T> : PrismaPromise<InputErrors>
   ...
   */
  export type RecommendationFindUniqueOrThrowArgs = RecommendationFindUniqueArgsBase
      

  /**
   * Recommendation: findFirstOrThrow
   */
  export type RecommendationFindFirstOrThrowArgs = RecommendationFindFirstArgsBase
  ...
  export type RecommendationWhereInput = {
    ...
    youtubeLink?: StringFilter | string
  ...
  export type RecommendationScalarWhereWithAggregatesInput = {
    ...
    youtubeLink?: StringWithAggregatesFilter | string
